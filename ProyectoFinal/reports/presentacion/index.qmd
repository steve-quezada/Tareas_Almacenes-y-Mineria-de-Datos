...
::: {#plot-edades-especiales .plotly-chart}
:::
...
## CLASACC: severidad del accidente

::: {#plot-severidad .plotly-chart}
:::

::: {.attention-note .attention-warning}
`CLASACC` será la variable objetivo para clasificación. El desbalance es fuerte: **Sólo daños** concentra **81.84%**, **No fatal** representa **17.05%** y **Fatal** apenas alcanza **1.12%**.
:::
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  Plotly.newPlot("plot-edades-especiales", [{
    type: "bar",
    x: ["0 · Conductor fugado", "99 · Edad desconocida"],
    y: [35037, 61564],
    marker: {
      color: [blueSoft, blueMid],
    ...
    ...baseLayout,
    xaxis: { title: "", tickfont: { size: 15 }, gridcolor: grid },
    yaxis: { title: "", gridcolor: grid, zeroline: false, range: [0, 70000] },
    margin: { l: 75, r: 35, t: 25, b: 75 }
  }, config);
...
## Localización: Vehículos y accidentes.
...
Rango de edad de los conductores: De 12 a 98 años.

¿Los accidentes son causados por infantes o personas de la tercera edad?

![](images/paste-7.png)

## ¿Habrá alguna hora donde sea raro que ocurran accidentes? No
...
## Concentración: Confirmación de tendencias.

Mediante el índice de concentración y curvas de Lorenz, respaldamos nuestras afirmaciones:

La curva tiene mayor area en la parte media-baja de la gráfica (sector de edad productivo)

![](images/paste-14.png)

## Confirmación de tendencias.

La curva presenta una mayor área en la parte media de la gráfica (mediodía).
...
En las horas parece ser que si, en los días de la semana, no tanto.

![](images/paste-12.png)

## Un problema generalizado.

Periodos vacacionales presentan mayor cantidad de accidentes. No los suficientes para establecer una tendencia.
